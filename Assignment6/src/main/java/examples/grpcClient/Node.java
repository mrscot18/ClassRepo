...
public class Node {
  ...
  private void start() throws IOException {
    ...
    server = ServerBuilder.forPort(port)
            ...
            .addService(new RockPaperScissor())
            .addService(new Hometowns())
            .addService(new Song())
            .build().start();
  ...
  public static void main(String[] args) throws IOException, InterruptedException {
    ...
    // Comment the next 2 lines for your local client server development (Activity 2
    // task 1, you need this part again for Task 2)
    // Register regThread = new Register(args[0], regPort, args[2], nodePort,
    // args[4]);
    // regThread.start();
